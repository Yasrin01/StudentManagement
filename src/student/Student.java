...
public class Student {
    ...
    public void insert(int id, String sname, String gender, String email, String phone, String father, String mother, String present,
            String permanent, String imagePath) {
    ...
    public void update(int id, String sname, String gender, String email, String phone, String father, String mother, String present,
            String permanent, String imagePath) {
        String sql = "update student set name=?,gender=?,email=?,phone=?,father_name=?,mother_name=?,"
                + "present_add=?,permanent_add=?,image_path=? where id=?";
        try {
            ps = con.prepareStatement(sql);
